...
from api.models import VolunteeringApplication
...
def getVolunteeringApplications(request):
    volunteeringApplications = VolunteeringApplication.objects.all()
...
def getVolunteeringApplication(request, pk):
    volunteeringApplication = VolunteeringApplication.objects.get(_id=pk)
...
def putVolunteeringApplication(request, pk):
    volunteeringApplication = JSONParser().parse(request)
    volunteeringApplication_data = VolunteeringApplication.objects.get(_id=pk)
